...
1) Install the composer vendors(get composer here: [http://getcomposer.org][14])
...
3) Start and open it in the browser
   ...
   **php bin/console server:run**
   ...
   Then go to the adress: [http://localhost:8000][15]
...
2) Test the API with clientId & clientSecret
